                ...
                <el-tab-pane label="查询条件" name="first">
                  ...
                  <el-table :data="tableData" border style="width: 100%">
                    <el-table-column
                      ...
                      min-width="58"
                    />
                    <el-table-column label="条件名" align="center" min-width="100px">
                    ...
                    <el-table-column label="数据类型" align="center" min-width="80px">
                      <template slot-scope="scope">
                        <el-select
                          v-model="tableData[scope.$index].paramType"
                          size="small"
                          style="width:100%"
                        >
                          ...
                          <el-option label="数字输入框" value="数字输入框" />
                        </el-select>
                      </template>
                    </el-table-column>
                    <el-table-column label="是否多选" align="center" min-width="100px">
                      <template slot-scope="scope">
                        <el-checkbox v-model="tableData[scope.$index].multipleSelect" />
                      </template>
                    </el-table-column>
                    <el-table-column label="字典" align="center" min-width="120px">
                      <template slot-scope="scope">
                        <el-input v-model.trim="tableData[scope.$index].dictCode" />
                      </template>
                    </el-table-column>
                    <el-table-column label="参数" align="center" min-width="150px">
                      <template slot-scope="scope">
                        <el-input v-model.trim="tableData[scope.$index].extParam" type="textarea" :rows="3" />
                      </template>
                    </el-table-column>
                    
                    <el-table-column label="默认值" align="center" min-width="150px">
                      <template slot-scope="scope">
                        <el-select
                          v-model="tableData[scope.$index].sampleItem"
                          filterable
                          allow-create
                        ...
                        >
                          ...
                          <el-option label="@当月第一天" value="@当月第一天" />
                          <el-option label="@当月最后一天" value="@当月最后一天" />
                          <el-option label="@上月第一天" value="@上月第一天" />
                          <el-option label="@上月最后一天" value="@上月最后一天" />
                          <el-option label="@当年第一天" value="@当年第一天" />
                          <el-option label="@当年最后一天" value="@当年最后一天" />
                          <el-option label="@当前登录用户" value="@当前登录用户" />
                          <el-option label="@当前登录用户部门" value="@当前登录用户部门" />
                        </el-select>
                      </template>
                    </el-table-column>
                    <el-table-column label="描述" align="center" min-width="100px">
                      <template slot-scope="scope">
                        <el-input
                    ...
                    <el-table-column label="校验" width="220px" align="center">
                      <template slot-scope="scope">
                        <el-checkbox
        ...
        dataSetPreview(row).then(data => {
          ...
          if (
            ...
            this.tableData.find((value, i) => {
              ...
              // Convert integer multipleSelect to boolean for checkbox
              this.tableData[i].multipleSelect = value.multipleSelect === 1;
            });
            if (count === 2) {
      ...
      this.$refs[formName].validate(async (valid, obj) => {
        if (valid) {
          if (this.testMassageCode == 200) {
            // Convert boolean multipleSelect to integer (0/1) for backend
            const paramList = this.tableData.map(item => ({
              ...item,
              multipleSelect: item.multipleSelect ? 1 : 0
            }));
            this.formData.dataSetParamDtoList = paramList;
