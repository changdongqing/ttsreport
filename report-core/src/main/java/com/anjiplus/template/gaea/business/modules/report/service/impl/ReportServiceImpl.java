                ...
                entities.forEach(report -> {
                    ...
                    switch (ReportTypeEnum.valueOf(reportType)) {
                        ...
                        case report_analysis:
                            LambdaQueryWrapper<ReportExcel> reportAnalysisLambdaQueryWrapper = Wrappers.lambdaQuery();
                            reportAnalysisLambdaQueryWrapper.eq(ReportExcel::getReportCode, reportCode);
                            reportExcelService.delete(reportAnalysisLambdaQueryWrapper);
                            break;
                        default:
                    }
                });
    ...
    public void copy(ReportDto dto) {
        ...
        switch (ReportTypeEnum.valueOf(reportType)) {
            ...
            case report_excel:
                ...
                break;
            case report_analysis:
                ReportExcel reportAnalysis = reportExcelService.selectOne("report_code", reportCode);
                if (null != reportAnalysis) {
                    reportAnalysis.setId(null);
                    reportAnalysis.setReportCode(copyReportCode);
                    reportExcelService.insert(reportAnalysis);
                }
